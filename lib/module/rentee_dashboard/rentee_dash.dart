...
class RenteeDashBoard extends StatefulWidget {
  final AppState appState;
  const RenteeDashBoard({Key? key, required this.appState}) : super(key: key);

  @override
  _RenteeDashBoardState createState() => _RenteeDashBoardState();
}

class _RenteeDashBoardState extends State<RenteeDashBoard> {
  @override
  void initState() {
    super.initState();
